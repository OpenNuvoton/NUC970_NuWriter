...
if(m_pack_tabcontrol.GetCurSel()==PACK_PAR)
{
	...
	{
		case DATA : flagstr.Format(_T("DATA"));		break;
		case ENV  : flagstr.Format(_T("ENV"));		break;
		case UBOOT: flagstr.Format(_T("uBOOT"));	break;
		case PACK : flagstr.Format(_T("Pack"));		break;
		case IMAGE : flagstr.Format(_T("FS"));	    break;			
	}		
	CString len;
	{
		FILE* rfp;
...
void CPACKDlg::OnNMDblclkPackImagelist(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	*pResult = 0;
	...
	//-----------------------------------------------------------------------------
		...
		switch((*itemType))
		{
			case 0: ((CButton *)m_packtab1.GetDlgItem(IDC_PACK_TYPE_A ))->SetCheck(TRUE); break;
			case 1: ((CButton *)m_packtab1.GetDlgItem(IDC_PACK_TYPE_A2))->SetCheck(TRUE); break;
			case 2: ((CButton *)m_packtab1.GetDlgItem(IDC_PACK_TYPE_A4))->SetCheck(TRUE); break;
			case 3: ((CButton *)m_packtab1.GetDlgItem(IDC_PACK_TYPE_A3))->SetCheck(TRUE); break;
			case 4: ((CButton *)m_packtab1.GetDlgItem(IDC_PACK_TYPE_A5))->SetCheck(TRUE); break;
		}
	//-----------------------------------------------------------------------------
		itemExec=ImageExec.begin()+modify_idx;	
	...
	//------------------------------------------------------------------------------
		...
		{
			case 0: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_M0))->SetCheck(TRUE); break;
			case 1: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_M1))->SetCheck(TRUE); break;
			case 2: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_M2))->SetCheck(TRUE); break;
			case 3: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_M3))->SetCheck(TRUE); break;
		}
		...
		{
			case 0: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_A0))->SetCheck(TRUE); break;
			case 1: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_A1))->SetCheck(TRUE); break;
			case 2: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_A2))->SetCheck(TRUE); break;
		}
		...
		{
			case 0: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_ENABLE ))->SetCheck(TRUE); break;
			case 1: ((CButton *)m_packtab2.GetDlgItem(IDC_PACK_MTP_DISABLE))->SetCheck(TRUE); break;			
		}
