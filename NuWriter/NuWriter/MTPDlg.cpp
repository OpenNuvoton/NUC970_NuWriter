	...
	switch(flag)
	{
		case 0:	
			...
			switch(_wtoi(tmp))
			{
				...
				case 1: ((CButton *)GetDlgItem(IDC_MTP_M1))->SetCheck(TRUE); break;
				case 2: ((CButton *)GetDlgItem(IDC_MTP_M2))->SetCheck(TRUE); break;
				case 3: ((CButton *)GetDlgItem(IDC_MTP_M3))->SetCheck(TRUE); break;
			}
			...
			switch(_wtoi(tmp))
			{
				case 0: ((CButton *)GetDlgItem(IDC_MTP_A0))->SetCheck(TRUE); break;
				case 1: ((CButton *)GetDlgItem(IDC_MTP_A1))->SetCheck(TRUE); break;
			}
