...
BOOL CNANDDlg::InitFile(int flag)
{
	...
	switch(flag)
	{
		case 0:			
			...
			switch(_wtoi(tmp))
			{
				case 0: ((CButton *)GetDlgItem(IDC_NAND_TYPE_A))->SetCheck(TRUE); break;
				case 1: ((CButton *)GetDlgItem(IDC_NAND_TYPE_A2))->SetCheck(TRUE); break;
				case 2: ((CButton *)GetDlgItem(IDC_NAND_TYPE_A4))->SetCheck(TRUE); break;
				case 3: ((CButton *)GetDlgItem(IDC_NAND_TYPE_A3))->SetCheck(TRUE); break;
				case 4: ((CButton *)GetDlgItem(IDC_NAND_TYPE_A5))->SetCheck(TRUE); break;
			}
